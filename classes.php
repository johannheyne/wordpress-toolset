<?php
	...
	$GLOBALS['toolset']['autoload_php_classes']['SubmenuWalker'] = 'tools/tool_walker_submenu/class.php';
	$GLOBALS['toolset']['autoload_php_classes']['BreadcrumbWalker'] = 'tools/tool_walker_breadcrumb/class.php';
	$GLOBALS['toolset']['autoload_php_classes']['wpSortableListColumn'] = 'tools/tool_sortable_list_column/class.php';
