<?php
	...
	// DEVELOPER {
		...
		function wp_control_dev_auto_updates( $value ) {
		   ...
		   return $GLOBALS['theme']['inits']['wp_auto_updates'][ config_get_site_type() ]['allow_dev_auto_core_updates'];
		}
	...
	// MINOR {
		...
		function wp_control_minor_auto_updates( $value ) {
		    ...
		    // true zum Aktivieren, false zum Deaktivieren
		    return $GLOBALS['theme']['inits']['wp_auto_updates'][ config_get_site_type() ]['allow_minor_auto_core_updates'];
		}
	...
	// MAJOR {
		...
		function wp_control_major_auto_updates( $value ) {
			...
			// true zum Aktivieren, false zum Deaktivieren
		    return $GLOBALS['theme']['inits']['wp_auto_updates'][ config_get_site_type() ]['allow_major_auto_core_updates'];
		}
	...
	// THEMES {
		...
		function wp_control_theme_auto_updates( $value ) {
			...
			// true zum Aktivieren, false zum Deaktivieren
			return $GLOBALS['theme']['inits']['wp_auto_updates'][ config_get_site_type() ]['auto_update_theme'];
		}
	...
	// PLUGINS {
		...
		function wp_control_plugin_auto_updates( $value ) {
			...
			// true zum Aktivieren, false zum Deaktivieren
		    return $GLOBALS['theme']['inits']['wp_auto_updates'][ config_get_site_type() ]['auto_update_plugin'];
		}
	...
	// TRANSLATIONS {
		...
		function wp_control_translation_auto_updates( $value ) {
			...
			// true zum Aktivieren, false zum Deaktivieren
		    return $GLOBALS['theme']['inits']['wp_auto_updates'][ config_get_site_type() ]['auto_update_translation'];
		}
