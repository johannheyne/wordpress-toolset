<?php
	...
	// TinyMCE EDITOR ( Version 3 ) {
		...
		function tool_tiny_mce_before_init( $init ) {
			...
			$init['block_formats'] = $GLOBALS['toolset']['inits']['tool_tinymce']['blockformats'];
		...
		function tool_mce_buttons( $buttons ) {
			...
			return $GLOBALS['toolset']['inits']['tool_tinymce']['toolbar-line-1'];
		}
		...
		function tool_mce_buttons_2( $buttons ) {
			...
			return $GLOBALS['toolset']['inits']['tool_tinymce']['toolbar-line-2'];
		}
